...
if Rails.env == "development"
	...
	FbApplication.create(
		name: "Static HTML", 
		app_id: "160483171205832",
		secret_key: "8575eb92bdb358d3baf6e43db4edc9c4", 
		application_type: "static_html", 
		canvas_id: "app9", 
	...
	FbApplication.create(
		name: "Promo Code", 
		app_id: "381337622310312",
		secret_key: "ad2db9c0806b55bc758e897b7d44f1bc", 
		application_type: "promo_code", 
		canvas_id: "app11", 
		namespace: "ita_dev_i_xi",
	)
	# Basic Plan
